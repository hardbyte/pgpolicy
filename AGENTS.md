...
4. **E2E** — kind cluster, deploys operator plus an OpenTelemetry Collector, runs happy-path plus conflict/invalid/missing-secret/secret-rotation operator scenarios, verifies roles in database, and verifies OTLP metrics export
